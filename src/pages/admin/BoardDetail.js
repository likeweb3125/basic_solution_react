...
const BoardDetail = () => {
    ...
    useEffect(() => {
        if (board_category) {
            const idx = common.boardMenu.findIndex(
                (item) => item.category == board_category
            );
    ...
    const getBoardData = () => {
        axios
            .get(
                `${board_detail
                    .replace(":category", board_category)
                    .replace(":idx", board_idx)}?pass=${passOk}`,
                {
                    headers: {
    ...
    return (
        <>
                        ...
                        <div className="board_view">
                            <div className="board_tit_box">
                                ...
                                <div className="btn_util">
                                    <Link
                                        to={`/console/board/post/modify/${board_category}/${board_idx}`}
                                    ...
                                    <button
                                        type="button"
                                        className="btn_type12"
                                        onClick={deltBtnClickHandler}
                                    >
                                        삭제
                                    </button>
                                </div>
                            ...
                            <div className="board_con">
                                ...
                                <div
                                    ...
                                    dangerouslySetInnerHTML={{
                                        __html: boardData.b_contents,
                                    }}
                                ></div>
                                {boardData.b_file &&
                                    boardData.b_file.length > 0 && (
                                        <div className="file_section">
                                            <span>첨부파일</span>
                                            <div>
                                                {boardData.b_file.map(
                                                    (cont, i) => {
                                                        return (
                                                            <button
                                                                type="button"
            ...
            {/* 댓글삭제 confirm팝업 */}
            {commentDeltConfirm && (
                <ConfirmPop onClickHandler={commentDeltHandler} />
            )}
