            ...
            <div className="comment_section">
                ...
                <div className="comment_wrap">
                    <div className="comment_box">
                        {list.map((cont, i) => {
                            const time = moment(cont.c_reg_date).format(
                            ...
                            if (admin) {
                                ...
                                if (login) {
                                    if (
                                        user.loginUser.m_email === cont.m_email
                                    ) {
                                        editBtnBox = true;
                                    }
                                }
                                    ...
                                    <div className="comment_item">
                                        ...
                                        {editBtnBox && (
                                            <>
                                                ...
                                                <div
                                                    className="comment_util"
                                                    style={editBtnBoxStyle}
                                                >
                                                    {editShow == cont.idx ? (
                                                        <button
                                                            type="button"
                    ...
                    <div className="write_comment_wrap">
                        ...
                        <div className="write_comment">
                            ...
                            <button
                                type="button"
                                className="btn_type14"
                                onClick={() => onEnterHandler(0, comment)}
                            >
                                등록
                            </button>
                        </div>
