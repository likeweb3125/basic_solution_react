                                ...
                                <div className="input_wrap">
                                    <div className="chk_rdo_wrap">
                                        <div className="rdo_box1">
                                            <input type="radio" id="check_thumb1" className="blind"
                                                onChange={(e)=>{
                                                    const checked = e.currentTarget.checked;
                                                    onCheckChangeHandler(checked,"b_thumbnail",1);
                                                }}
                                                checked={info.b_thumbnail && info.b_thumbnail == 1 ? true : false}
                                                name="check_thumb"
                                            />
                                            <label htmlFor="check_thumb1">커버</label>
                                        </div>
                                        <div className="rdo_box1">
                                            <input type="radio" id="check_thumb2" className="blind"
                                                onChange={(e)=>{
                                                    const checked = e.currentTarget.checked;
                                                    onCheckChangeHandler(checked,"b_thumbnail",2);
                                                }}
                                                checked={info.b_thumbnail && info.b_thumbnail == 2 ? true : false}
                                                name="check_thumb"
                                            />
                                            <label htmlFor="check_thumb2">원본 사이즈 고정</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
